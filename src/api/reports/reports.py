...
class ReportsController(Controller):
    ...
    async def get_stocks(
        ...
        return await ReportsService().get_stocks(date_from)
    ...
    async def get_orders(
        ...
        return await ReportsService().get_orders(date_from)
    ...
    async def get_sales(
        ...
        return await ReportsService().get_sales(date_from)
    ...
    async def get_excise_report(self, data: ExciseReportRequest) -> dict:
        return await ReportsService().get_excise_report(data)
    ...
    async def create_warehouse_remains_task(
        ...
        return await ReportsService().create_warehouse_remains_task(params)
    ...
    async def get_warehouse_remains_status(
        ...
        return await ReportsService().get_warehouse_remains_status(task_id)
    ...
    async def download_warehouse_remains(
        ...
        return await ReportsService().download_warehouse_remains(task_id)
    ...
    async def get_measurement_penalties(
        ...
        return await ReportsService().get_measurement_penalties(date_from, date_to, limit, offset)
    ...
    async def get_warehouse_measurements(
        ...
        return await ReportsService().get_warehouse_measurements(date_from, date_to, limit, offset)
    ...
    async def get_deductions(
        ...
        return await ReportsService().get_deductions(date_from, date_to, sort, order, limit, offset)
    ...
    async def get_antifraud_details(self) -> dict:
        return await ReportsService().get_antifraud_details()
    ...
    async def get_goods_labeling(self) -> dict:
        return await ReportsService().get_goods_labeling()
    ...
    async def create_acceptance_report_task(self) -> dict:
        return await ReportsService().create_acceptance_report_task()
    ...
    async def get_acceptance_report_status(
        ...
        return await ReportsService().get_acceptance_report_status(task_id)
    ...
    async def download_acceptance_report(
        ...
        return await ReportsService().download_acceptance_report(task_id)
    ...
    async def create_paid_storage_task(
        ...
        return await ReportsService().create_paid_storage_task(date_from, date_to)
    ...
    async def get_paid_storage_status(
        ...
        return await ReportsService().get_paid_storage_status(task_id)
    ...
    async def download_paid_storage(
        ...
        return await ReportsService().download_paid_storage(task_id)
    ...
    async def get_region_sale(self) -> dict:
        return await ReportsService().get_region_sale()
    ...
    async def get_brand_brands(self) -> dict:
        return await ReportsService().get_brand_brands()
    ...
    async def get_brand_parent_subjects(
        ...
        return await ReportsService().get_brand_parent_subjects(locale, brand)
    ...
    async def get_brand_share(
        ...
        return await ReportsService().get_brand_share(parent_id, brand)
    ...
    async def get_blocked_products(
        ...
        return await ReportsService().get_blocked_products(sort, order)
    ...
    async def get_shadowed_products(
        ...
        return await ReportsService().get_shadowed_products(sort, order)
    ...
    async def get_goods_return(
        ...
        return await ReportsService().get_goods_return(date_from, date_to)
