...
class SuppliesController(Controller):
    ...
    @post(
        ...
        description=(
            ...
            "После создания добавьте сборочные задания через `PATCH /fbs/wb/supplies/{id}/orders`, "
            "затем передайте поставку в доставку через `PATCH /fbs/wb/supplies/{id}/deliver`.\n\n"
