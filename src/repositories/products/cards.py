        ...
        rows = [
            {
                ...
                "length": card.dimensions.length if card.dimensions else None,
                "width": card.dimensions.width if card.dimensions else None,
                "height": card.dimensions.height if card.dimensions else None,
