...
from src.services.tariffs.tariffs import TariffsService


class TariffsController(Controller):
    path = "/tariffs"
    tags = ["Тарифы"]
    ...
    async def get_commissions(self) -> dict:
        return await TariffsService().get_commissions()
    ...
    async def get_return_cost(
        ...
        return await TariffsService().get_return_cost(date)
    ...
    async def get_box_tariffs(
        ...
        return await TariffsService().get_box_tariffs(date)
    ...
    async def get_pallet_tariffs(
        ...
        return await TariffsService().get_pallet_tariffs(date)
    ...
    async def get_supply_tariffs(
        ...
        return await TariffsService().get_supply_tariffs(date)
