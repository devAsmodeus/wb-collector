...
class FinancesController(Controller):
    ...
    async def get_balance(self) -> dict:
        return await FinancesService().get_balance()
    ...
    async def get_financial_report(
        ...
        return await FinancesService().get_financial_report(date_from, date_to, limit, rrdid, period)
    ...
    async def get_document_categories(self) -> dict:
        return await FinancesService().get_document_categories()
    ...
    async def get_documents(
        ...
        return await FinancesService().get_documents(begin_time, end_time, sort, order, category, service_name, limit, offset)
    ...
    async def download_document(
        ...
        return await FinancesService().download_document(service_name, extension)
    ...
    async def download_all_documents(self, data: DownloadAllDocumentsRequest) -> dict:
        return await FinancesService().download_all_documents(data)
